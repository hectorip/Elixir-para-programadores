defmodule ApiTestWeb.BookLive.Index do
  use ApiTestWeb, :live_view

  alias ApiTest.Library
  alias ApiTest.Library.Book
  ...
  @impl true
  def handle_info({ApiTestWeb.BookLive.FormComponent, {:saved, book}}, socket) do
